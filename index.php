...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,500&family=Noto+Sans:ital@0;1&family=Roboto:wght@100..900&display=swap"
    rel="stylesheet">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link
    href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,500&family=Noto+Sans:ital,wght@0,600;1,600&family=Roboto:wght@100..900&display=swap"
    rel="stylesheet">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link
    href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,500&family=Noto+Sans:ital,wght@0,700;1,700&family=Roboto:wght@100..900&display=swap"
    rel="stylesheet">
...
<body class="front-page">
  <div class="mobile-menu">
    ...
    <div class="mobile-info">
      <svg class="address-svg" width="24px" height="24px">
    ...
    <a href="" class="social">
      <svg class="vk-svg" width="24px" height="24px">
        <use href="img/sprite.svg#vk"></use>
      </svg>
    </a>
    <a href="" class="social">
      <svg class="inst-svg" width="24px" height="24px">
    ...
    <div class="container">
      ...
      <div class="swiper steps-slider">
        ...
        <ol class="swiper-wrapper steps">
          <!-- Slides -->
          <li class="swiper-slide steps-item-1">
          ...
          <li class="swiper-slide steps-item-4">
        ...
        <div class="steps-buttons primary-buttons-wrapper">
          <div class="steps-button-prev primary-button-prev">
            <svg width="60px" height="40px">
              <use href="/img/sprite.svg#arr-prev"></use>
            </svg>
          </div>
          <div class="steps-button-next primary-button-next">
            <svg width="60px" height="40px">
              <use href="/img/sprite.svg#arr-next"></use>
            </svg>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="cards">
        <a href="#" class="card">
          ...
          <!-- /.card-content -->
          <img src="/img/avto-chem.png" alt="Автомобильная химия" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
          ...
          <!-- /.card-content -->
          <img src="/img/household-chem.png" alt="Бытовая химия" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
        ...
        <a href="#" class="card">
          ...
          <!-- /.card-content -->
          <img src="/img/avto-chem.png" alt="Косметическая продукция" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
          ...
          <!-- /.card-content -->
          <img src="/img/household-chem.png" alt="Краски аэрозольные" class="card-image">
        </a>
      </div>
      <!-- /.cards -->
    </div>
        ...
        <div class="clients-content">
          ...
          <ul class="clients-list">
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-1"></use>
              </svg>
              Химические производства
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-2"></use>
              </svg>
              Автомойки
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-3"></use>
              </svg>
              Пищевая продукция
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-4"></use>
              </svg>
              Лаки и краски
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-5"></use>
              </svg>
              Косметические средства
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-6"></use>
              </svg>
              Автомобильная косметика
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-7"></use>
              </svg>
              Косметика по уходу за одеждой
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-8"></use>
              </svg>
              Косметика по уходу за обувью
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-9"></use>
              </svg>
              Строительные материалы
            </li>
            <li class="clients-list-item">
              <svg width="30px" height="30px" class="client-list-icon">
                <use href="/img/sprite.svg#Vector-10"></use>
              </svg>
              И многих других
            </li>
          </ul>
      ...
      <div class="swiper blog-slider">
        ...
        <div class="swiper-wrapper">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img class="blog-card-image" src="/img/blog/pexels-pixabay-208661 1.jpg" alt="">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img class="blog-card-image" src="/img/blog/pexels-tima-miroshnichenko-9574410 2.jpg" alt="">
            <h3 class="blog-card-title">
